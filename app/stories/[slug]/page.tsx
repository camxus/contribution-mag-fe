        ...
        >
          ...
          >
            ...
            >
              ...
              <span className="hidden h-px w-5 bg-white/50 sm:block" />
            ...
            <motion.h1
              ...
              className="
                ...
                leading-[0.84]
                tracking-[-0.075em]
                sm:text-[clamp(56px,9vw,92px)]
                sm:leading-[0.81]
                sm:tracking-[-0.09em]
                lg:text-[clamp(72px,8vw,128px)]
                lg:leading-[0.79]
                lg:tracking-[-0.105em]
              "
            >
